...
- **🪟 Polished window** — responsive collapsing layout, restores its size/maximized state, scroll-follows-cursor across panels, and **double-click any panel splitter to reset it**. Panel widths *and* the Explorer/Git split are **remembered across sessions and restarts**.

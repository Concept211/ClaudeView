...
- **🧠 1M-token context for Opus & Sonnet** — sessions automatically request the extended context window instead of the default 200K, so the ring in the composer reflects how much room you actually have.
